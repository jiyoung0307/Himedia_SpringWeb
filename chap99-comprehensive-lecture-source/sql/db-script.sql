...
CREATE TABLE TBL_MEMBER(
  ...
  MEMBER_ROLE VARCHAR2(15) DEFAULT 'ROLE_MEMBER' CHECK(MEMBER_ROLE IN ('ROLE_MEMBER', 'ROLE_ADMIN')),
  MEMBER_STATUS VARCHAR2(2) DEFAULT 'Y'
);

-- 관리자 계정 추가
INSERT INTO TBL_MEMBER (MEMBER_NO, MEMBER_ID, MEMBER_PWD, NICKNAME, PHONE, EMAIL, MEMBER_ROLE) VALUES (SEQ_MEMBER_NO.NEXTVAL, 'admin', '$2a$10$7NqnZ0pUQh2RDLDkcEmubOSWB2DSewpDNs7q7xwxgZHHvMgZGJ.rW', '관리자', '01012345678', 'admin@greedy.com', 'ROLE_ADMIN');
COMMIT;
